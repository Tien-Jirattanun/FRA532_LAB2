...
class LQRController : public rclcpp::Node
{
  public:
        ...
        : Node("lqr_controller")
    {
        ...
        K.setZero();
        K <<     0.00000000,-0.00000000,5.47722558,0.00000000, -0.00000000,4.62943590,0.00000000,0.00000000, 0.00000000,0.00000000,0.00000000,0.00000000, -0.00000000,-3.87298335,-0.00000000,0.00000000, -2.64690884,-0.00000000,5.70685390,0.00000000, 0.00000000,0.66835488,0.00000000,-0.00000000, 3.87298335,0.00000000,-0.00000000,2.87965361, 0.00000000,-0.00000000,-0.00000000,7.33588133, 0.00000000,0.00000000,1.03779737,0.00000000, -0.00000000,0.00000000,-0.00000000,-0.00000000, 0.00000000,-0.00000000,-0.00000000,-0.00000000, 1.00000000,-0.00000000,-0.00000000,0.49537864;
  ...
  private:
    ...
    void timer_callback()
    {
        ...
        error(0) = std::clamp(error(0), -1.0, 1.0); // Cap X error to 2 meters
        error(1) = std::clamp(error(1), -1.0, 1.0); // Cap Y error to 2 meters
        error(2) = std::clamp(error(2), -1.0, 1.0); // Cap Y error to 2 meters
